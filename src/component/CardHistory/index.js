...
function CardHistory({ heigth }) {
    ...
    return (
        <>
            <div className={`flex flex-col md:bg-white  md:rounded-2xl w-full  md:shadow-xl ${heigth} p-5`}>
                ...
                <div className='overflow-scroll scrollbar-hide'>
                    {
                        data?.map((item, i) => (
                            ...
                            <div key={i} className="bg-base-100 shadow-md w-full my-2 md:my-4 md:shadow-none" >
                                <div className=" flex flex-row justify-between items-center">
                                    <div className='flex items-center gap-2'>
                                        <Image src={avatar} alt="avataravatar" className='w-12 h-12' />
                                        <div className='w-2/3'>
                                            <p className='font-semibold text-md mb-1'>{item.reciever_name}</p>
