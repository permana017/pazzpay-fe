            ...
            <section className='w-full flex justify-center bg-[#473AD10F]'>
                <div className='container'>
                    <div className='md:py-[90px] py-12'>
                        <Image src={imgPartner} alt="partner" className='md:h-[120px] h-[60px] w-full' />
                    </div>
                </div>
            </section>
                            ...
                            <Fade bottom>
                                <div className="card md:w-[32%] w-full mb-8 md:mb-0 bg-base-100 shadow-xl ">
                                    <div className="card-body items-center">
                                        ...
                                        <p className='w-[90%] text-center text-[#3A3D42E5]'>We have 24/7 contact support
                            ...
                            <Fade bottom delay={200}>
                                <div className="card md:w-[32%] w-full mb-8 md:mb-0 bg-base-100 shadow-xl">
                                    <div className="card-body items-center">
                                        ...
                                        <p className='w-[90%] text-center text-[#3A3D42E5]'>We make sure your data is
                            ...
                            <Fade bottom delay={400}>
                                <div className="card md:w-[32%] w-full mb-8 md:mb-0 bg-base-100 shadow-xl">
                                    <div className="card-body items-center">
                                        ...
                                        <p className='w-[90%] text-center text-[#3A3D42E5]'>Zwallet is 100% totally free
                                ...
                                <div className="carousel w-full">
                                    <div
                                        ...
                                        <div className='w-[90%] bg-white md:p-14 p-8 my-14 flex flex-col items-center shadow-xl rounded-xl'>
                                            <Image src={imgResponder} alt="hahah" className='w-[120px] h-[120px]' />
                                            <p className='text-2xl font-semibold mt-4 mb-2'>Alex Hansinburg</p>
                                            <p className='text-[#56585B] text-lg '>Designer</p>
                                            <p className='text-[#56585B] text-xl text-center mt-12'>“This is the most outstanding app that I’ve ever try in my live, this app is
                                        ...
                                        <div
                                            className=" hidden absolute md:flex justify-between transform -translate-y-1/2 left-0 right-0 top-1/2">
                                            <a href="#slide4" className="btn bg-white border-none shadow-lg">❮</a>
                                            <a href="#slide2" className="btn bg-white border-none shadow-lg">❯</a>
                                        </div>
                                    </div>
                                    <div
                                        id="slide2"
                                        ...
                                        <div
                                            className=" hidden absolute md:flex justify-between transform -translate-y-1/2 left-0 right-0 top-1/2">
                                            <a href="#slide1" className="btn bg-white border-none shadow-lg">❮</a>
                                            <a href="#slide3" className="btn bg-white border-none shadow-lg">❯</a>
                                        </div>
                                    </div>
                                    <div
                                        id="slide3"
                ...
                <div className='container'>
                    <div className='py-12 md:py-20 w-full'>
                        <div className='border-b-[1px] pb-12 mb-4'>
                            <Fade left delay={200}>
                                <p className='text-white font-semibold  text-[34px] mb-[30px]'>FazzPay</p>
                            </Fade>
                            <Fade left delay={400}>
